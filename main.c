...
int main(int argc, const char * argv[]){
	...
	*/
	...
	/*Lista con todos los partidos del mundial*/
	if (TraerPartidos(Brasil2014.equipos, Brasil2014.q_equipos, &listaPartidos) == TRUE){
		fprintf(stderr, "Error General de archivo.\n");
		return 1;
	}
	...
	/*se crea la lista de partidos jugados a partir del binario y luego se valida*/
	...
	ValidarPartidosJugados(Brasil2014.partidosJugados, listaPartidos);
				...
				while (state_submenu_partidos != opt_subpartidos_return) {
					...
					case opt_partidonuevojugado:
						...
						while (state_subsubmenu_partidonuevo != opt_subpartidosnuevo_return) {
							...
							//("%ul",&state_subsubmenu_partidonuevo);
							...
							case opt_equipo:
								...
								printf("Ingrese el id del equipo1 que jugo: ");
								scanf("%s",idEquipo1);
								printf("Ingrese el id del equipo2 que jugo: ");
								scanf("%s", idEquipo2);
								dump_line(stdin);
								if ((partidoAux = BuscarPartidoPorEquipos(Brasil2014.partidosPendientes, idEquipo1, idEquipo2)) == NULL){
									if ((partidoAux = BuscarPartidoPorEquipos(Brasil2014.partidosJugados, idEquipo1, idEquipo2)) == NULL){
										fprintf(stderr, "No existe un partido con los id: %s %s! (Respete las mayusculas)\n", idEquipo1, idEquipo2);
										getchar();
										break;
									}
									printf("Ese partido ya se jugo.\n Por Favor utilize el submenu de partidos jugados opcion 1) Modificar.\n");
